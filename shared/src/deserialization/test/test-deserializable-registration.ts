...
function testDeserializableRegistration(done: MochaDone): void {
    ...
    for (let i: number = 0; i < getDeserializableArgArr.length; i++) {
...
function testRecordDeepDeserializableMembers(done: MochaDone): void {4
    ...
    for (let i: number = 0; i < deepDeserializableMemberNames.length; i++) {
