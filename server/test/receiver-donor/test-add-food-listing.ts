...
import { shallowValidateFoodListing } from '../common-receiver-donor-deliverer/util/validate-food-listing';

import { FoodListing, AddFoodListingRequest, AddFoodListingResponse } from '../../../shared/src/receiver-donor/message/add-food-listing-message';
import { GetFoodListingsRequest, FoodListingFilters, GetFoodListingsResponse } from '../../../shared/src/common-receiver-donor-deliverer/message/get-food-listings-message';


const ADD_ROUTE: string = '/receiverDonor/donor/addFoodListing';
const GET_ROUTE: string = '/receiverDonor/getFoodListings';
