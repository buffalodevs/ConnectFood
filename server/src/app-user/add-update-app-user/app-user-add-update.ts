 ...
 */
export async function addOrUpdateAppUser(appUser: AppUser, password?: string, appUserUpdateKey?: number): Promise <SessionData> {
    ...
    const mustGenAppUserAvailability: boolean = (!isUpdate || (appUser.availability != null && appUser.availability.timeRanges != null));
    ...
    appUser.availability.timeRanges = mustGenAppUserAvailability ? absToAvailabililityDateRanges(appUser.availability.timeRanges)
                                                                 : null;
