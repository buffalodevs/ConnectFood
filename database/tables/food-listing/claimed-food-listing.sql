...
ALTER TABLE ClaimedFoodListing ADD COLUMN IF NOT EXISTS receiverAppUserKey  INTEGER NOT NULL REFERENCES AppUser (appUserKey);
...
CREATE INDEX IF NOT EXISTS claimedFoodListing_ClaimedByAppUserKey   ON ClaimedFoodListing (receiverAppUserKey);
